...
class SliverStaggeredGridGeometry extends SliverGridGeometry {
  ...
  const SliverStaggeredGridGeometry({double? scrollOffset, double? crossAxisOffset,
     double? mainAxisExtent, double? crossAxisExtent, this.crossAxisCellCount, this.blockIndex,
  }) : super(
  ...
  bool get hasTrailingScrollOffset => true;
